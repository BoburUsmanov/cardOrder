			...
			<div className="demo" id="slider">
				...
				<div className="slider owl-carousel">
					<div className="demo__item uzcard">
						...
						<p className="demo__text">{ln["uzcard__text"]}</p>
					...
					<div className="demo__item">
						...
						<p className="demo__text">{ln["plan"]}</p>
					...
					<div className="demo__item">
						...
						<p className="demo__text">{ln["grace__text"]}</p>
					...
					<div className="demo__item">
						...
						<h3 className="demo__subtitle">{ln["free"]}</h3>

						<p className="demo__text">{ln["balance"]}</p>
